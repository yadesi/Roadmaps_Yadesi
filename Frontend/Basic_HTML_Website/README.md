...
- HTML sémantique : Utilisez les balises HTML appropriées pour structurer mon CV.
- Balises méta SEO : incluez les balises méta essentielles pour le référencement naturel.
- Balises Open Graph (OG) : ajoutez des balises OG pour améliorer le partage sur les réseaux sociaux.
- Favicon : ajoutez une favicon à votre page CV.
